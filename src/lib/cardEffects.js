...
const allCards = {
    ...
    'Bloody Dagger': { title: 'Bloody Dagger', get effect() { return getCardEffect('Bloody Dagger', { hp: 2, attack: this.attack }) }, get description() { return "Lose 2 HP, Gain " + this.attack + " Attack" }, onAdd: undefined, attack: 10, moves: undefined, gold: undefined },
