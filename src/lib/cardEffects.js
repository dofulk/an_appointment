...
const allCards = {
    ...
    'Wetstone': { title: 'Wetstone', get effect() { return getCardEffect('Attack', { attack: this.attack }) }, get description() { return '+ ' + this.attack + ' Attack. On Add, add 2 to a random card with Attack' }, onAdd: addToUpgradeQueue({ method: 'random', type: 'attack', amount: 2 }), attack: 3, moves: undefined, gold: undefined },
