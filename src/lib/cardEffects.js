...
import { changeAttack, changeGold, changeHp, changeMoves, addOnKill, addOnMove, addOnAttack, changeRemoveAmount } from '../redux/actions/action'
...
const cardEffects = {
    ...
    'Meatball': {title: 'Meatball', effect: addOnKill({ action: changeAttack('player', 5), removeOn: 'endCycle' }), description: 'Gain 5 Attack on a Kill', onAdd: undefined},
    ...
    'Glass Cannon': {title: 'Glass Cannon', effect: glassCannon(), description: 'Gain 10 Attack, Lose 3 Attack when you Move', onAdd: undefined},
