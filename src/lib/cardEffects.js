...
const cardEffects = {
    ...
    'Meatball': {title: 'Meatball', effect: addOnKill({ action: changeAttack('player', 5), removeOn: 'endCycle' }), description: 'Gain 5 Attack on a Kill'},
    'Sneak Attack': {title: 'Sneak Attack', effect: addOnMove({ action: changeAttack('player', 2), removeOn: 'endCycle' }), description: 'Gain 2 Attack when you Move'},
    'Golden Boot': {title: 'Golden Boot', effect: addOnMove({ action: changeGold(3), removeOn: 'endCycle' }), description: 'Gain 3 Gold when you Move'},
    'Fury Blows': {title: 'Fury Blows', effect: addOnAttack({ action: changeAttack('player', 2), removeOn: 'endCycle' }), description: 'Gain 2 Attack when you Attack'},
